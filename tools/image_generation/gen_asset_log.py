...
ROWS = [
    ...
    ('q017_heart_chambers', 'existing', 'なし(既存実写asset)', 'Q017, Q064, Q129(判定は本ログで確定), Q230(新規), Q231(新規)',
     '左心室/4腔同時/腱索・乳頭筋/心室中隔/心房中隔', '既存採用済み。今回はmarker追加のみ検討(Q230/Q231)。実装時にoverlay再実測。', 'accepted'),
    ('q037_alveolar_gas_exchange', 'existing', 'なし(既存実写asset)', 'Q037, Q084(新規)',
     '肺胞から血液へ向かう矢印/血液空気関門3層', '既存採用済み。今回変更なし。', 'accepted'),
    ('q048_nephron', 'existing', 'なし(既存実写asset)', 'Q048, Q176, Q177(新規), Q178(新規), Q199(新規), Q200(新規)',
     '腎小体/ボーマン嚢/近位尿細管/ヘンレ係蹄/順路overlay/輸入輸出細動脈', '既存採用済み。今回変更なし。', 'accepted'),
